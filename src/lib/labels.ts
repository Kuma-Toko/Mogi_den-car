...
export const auditActionLabel: Record<string, string> = {
  ...
  case_edit: "症例を編集",
  case_delete: "症例を削除",
  case_template_create: "症例テンプレートを登録",
  case_template_update: "症例テンプレートを更新",
  case_template_delete: "症例テンプレートを削除",
  case_template_from_case: "症例からテンプレートを作成",
  case_template_generate: "症例テンプレートから症例を一括生成",
  case_template_publish_batch: "症例テンプレート生成分の下書きを一括公開",
