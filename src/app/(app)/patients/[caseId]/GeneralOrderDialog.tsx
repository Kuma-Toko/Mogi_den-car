...
const SELECT_OPTIONS: Record<string, string[]> = {
  ...
  // 選択肢の文言はphysiology-engine.tsのVITALS_INTERVAL_HOURS_BY_SELECTIONのキーと対応させる。
  // 急変（急変状態=CRITICAL）発生中はこの指示に関わらずリアルタイム相当（15分ごと）に自動で切り替わる。
  バイタル測定: ["2時間ごと（1日12回）", "4時間ごと（1日6回）", "8時間ごと（1日3回）"],
  酸素投与: [
    "鼻カニューレ 1L/分",
    "鼻カニューレ 2L/分",
    "鼻カニューレ 3L/分",
