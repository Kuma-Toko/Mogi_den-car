    ...
    <>
      ...
      <div className="content">
        ...
        <div className="card" style={{ marginBottom: 14 }}>
          <div className="card-h">原因菌一覧</div>
          <div className="card-b" style={{ padding: 0 }}>
            {pathogens.length === 0 ? (
              <div className="empty-note">原因菌が登録されていません。</div>
            ) : (
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  {pathogens.map((pathogen) => {
                    ...
                    return (
                      <tr className="row" key={pathogen.id}>
                        <td>{pathogen.name}</td>
                        <td>{pathogen.gramStain ?? "—"}</td>
                        <td>{pathogen.susceptibilities.length}件</td>
                        <td>
                          <Modal trigger="編集" triggerClassName="btn ghost" title={pathogen.name}>
